...
module.exports = Backbone.View.extend({
	id: 'LoginPanel',
	className: 'container',
	template: `<h2>Welcome to Kegbot <span rv-if="OrgName"> for { OrgName }</span>!</h2>
		<h4>
			An <a href="https://github.com/Thann/Kegbot" target="_blank" rel="nofollow">open source</a>
		...
		<br>
			...
			<a href="https://github.com/Thann/Kegbot/blob/master/README.md" target="_blank">readme</a>.
		</p>
	...
	changePW: function(evt) {
		...
		Kegbot.User.save({
			...
			success: function(m) {
				...
				Kegbot.Router.navigate('', {trigger: true});
